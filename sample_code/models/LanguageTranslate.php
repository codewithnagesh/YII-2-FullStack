...
namespace global\translate\models;
...
class LanguageTranslate extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'integer'],
            [['id'], 'exist', 'targetClass' => '\global\translate\models\LanguageSource'],
            [['language'], 'exist', 'targetClass' => '\global\translate\models\Language', 'targetAttribute' => 'language_id'],
            [['translation'], 'string'],
